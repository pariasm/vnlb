/* This is a verbatim copy of CImg option functions, so that they can be used
 * independently of CImg. To avoid name colisions, cimg_ prefixes have been
 * replaced by clo_.
 *
 * The original code is part of the CImg project (http://cimg.eu/)
 * lead by David Tschumperlé.
 *
 * The CImg Library is an open-source product distributed under two distinct
 * licenses : the library core itself is dual-licensed and can be governed
 * either by the CeCILL-C License (LGPL-like), or the CeCILL License
 * (GPL-compatible).
 *
 * This file is distributed with the same license as the CImg library.
 */
